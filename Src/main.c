...
int main(void)
{
  ...
  while (1)
  {
	   ...
	   //temp2 = (uint8_t)dhtsensorvar.TEMPERATURE;
	 temp2 = HAL_GPIO_ReadPin(gpio_input_GPIO_Port, GPIO_PIN_1);
	  ...
	  HAL_SPI_Transmit(&hspi1, &temp2, 10, 100);
	  HAL_Delay(100);
    /* USER CODE END WHILE */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : gpio_input_Pin_Pin slave_select_Pin */
  GPIO_InitStruct.Pin = gpio_input_Pin_Pin|slave_select_Pin;
